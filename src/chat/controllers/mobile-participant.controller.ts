...
/**
 * Controller for handling mobile app participant-related HTTP requests
 * Provides REST API endpoints for participant management without authentication
 * Used by mobile applications that don't require user authentication
 */
@ApiTags('mobile-participants')
@Controller('mobile-participants')
export class MobileParticipantController {
  constructor(
